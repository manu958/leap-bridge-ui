    ...
    <>
      ...
      <main className="w-full">
        ...
        <section className="relative h-screen min-h-[560px]">
          {/* Background Image */}
          <Image
            src="/assests/header/about section images/_about 1c.webp"
          ...
          <div className="relative z-10 container mx-auto h-full flex items-center">
            <div className="px-6 md:px-10 lg:px-16 xl:px-24 max-w-4xl">
              {/* Heading */}
              <h1 className="font-serif text-[44px] md:text-[64px] lg:text-[96px] leading-[0.98] md:leading-[0.95] text-[#d7efe6]">
                Serious about what
                <br />
                we do. In a fun way.
              </h1>
              ...
              <p className="mt-6 text-lg md:text-xl text-[#bfe6d8]">
                Changing digital landscape since 2012
              </p>
            </div>
          </div>
        </section>
