            ...
            <div className="hidden md:flex items-center justify-center flex-1">
              ...
              <div className="relative group">
                <Link href="/" onClick={() => handleLinkClick("/")}>
                  <button
                    className={`text-lg px-6 py-4 flex items-center ${activeLink === "/" ? "text-[#53FFA9]" : "text-[var(--lgreen)]"
                      }`}
                  >
                    Home
                  </button>
              ...
              <div className="relative group">
                <Link href="#about" onClick={() => handleLinkClick("#about")}>
                  <button
                    className={`text-lg px-6 py-4 flex items-center ${activeLink === "#about" ? "text-[#53FFA9]" : "text-[var(--lgreen)]"
                      }`}
                  >
                    About Us
                  </button>
              ...
              <div className="relative group">
                <Link href="#category" onClick={() => handleLinkClick("#category")}>
                  <button
                    className={`text-lg px-6 py-4 flex items-center ${activeLink === "#category" ? "text-[#53FFA9]" : "text-[var(--lgreen)]"
                      }`}
                  >
                    Category Experience
                  </button>
              ...
              <div className="relative group">
                <Link href="#service" onClick={() => handleLinkClick("#service")}>
                  <button
                    className={`text-lg px-6 py-4 flex items-center ${activeLink === "#service" ? "text-[#53FFA9]" : "text-[var(--lgreen)]"
                      }`}
                  >
                    Services
                  </button>
              ...
              <div className="relative group">
                <Link href="#contact" onClick={() => handleLinkClick("#contact")}>
                  <button
                    className={`text-lg px-6 py-4 flex items-center ${activeLink === "#contact" ? "text-[#53FFA9]" : "text-[var(--lgreen)]"
                      }`}
                  >
                    Contact Us
                  </button>
